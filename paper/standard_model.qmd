...
```{r fig-schematic, fig.width=13, fig.height=6.5}
#| label: fig-schematic
#| fig-cap: ""
# Schematic walk through the model ladder. Five columns are model
# variants (A → E); the top row shows the latent ability theta_i(t),
...
variants <- tibble::tribble(
  ...
  "(E) + per-kid input variance", 2.5,         1.3,          0.8,          0.4,     r"($\theta = \log(\alpha_i) + \log(r_i) + \kappa_i\,\log(t)$)"
)
