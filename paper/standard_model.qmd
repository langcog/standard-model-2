...
source(here::here("outputs", "paper", "_helpers.R"))
```
...
#| tbl-cap: ""
knitr::kable(
  make_table1_datasets(),
  col.names = c("Panel", "Dataset", "Citation", "N children",
                "Admins/kid (median, range)", "Age range", "Input/recordings"),
  align = "lllrlll"
)
```
...
#| fig-cap: ""
#| out-width: 100%
knitr::include_graphics(fig3_png_path())
```
...
knitr::include_graphics(
  here::here("outputs", "figs", "longitudinal", "exposure_to_learn_EN.png")
)
```
...
#| fig-height: 4.5
panels <- fig6_panels()
# Two-panel composite assembled via patchwork from existing PNGs.
# Author iterates on the final figure choice.
