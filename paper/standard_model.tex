...
investigation and extension of accumulator models. All models start with
the observation that the overall size of children's vocabulary increases
supra-linearly. But does this growth imply changes in the underlying
process?
...
growth) accelerates across development (Hidaka 2013). In the bucket
metaphor, the drops get bigger as children get older. We begin by
extending the psychometric accumulator model of Kachergis, Marchman, and
Frank (2022): our key addition is to describe variation between
individual children by modeling both their individual learning
...
measures, though stronger in acceleration (\(\beta = 0.03\),
\(p = .096\)) than in efficiency (\(\beta = 0.06\), \(p = .157\)). One
