...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.0744}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.0909}}
  >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1653}}
...
(\textbf{CITE?})
& 22 & 5.0 & 6--32 mo & Head-cam (n = 5,739 videos) \\
Input-observed (IO) & SEEDLingS &
(\textbf{CITE?})
& 44 & 12.0 & 6--17 mo & LENA day (n = 525 recordings) \\
Input-observed (IO) & AM2018 &
(\textbf{CITE?})
& 66 & 3.0 & 16--24 mo & LENA (n = 126 recordings) \\
Input-observed (IO) & FMW2013 &
(\textbf{CITE?})
& 51 & 3.0 & 18--30 mo & LENA (n = 51 recordings) \\
