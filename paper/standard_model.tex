...
itself primarily in efficiency (\(\beta = -0.33\), \(p = < .001\)),
rather than acceleration (\(\beta = 0\), \(p = .939\)). In contrast,
maternal education effects were present in both measures, but stronger
in acceleration ( efficiency: \(\beta = 0.06\), \(p = .157\);
acceleration: \(\beta = 0.03\), \(p = .096\)). One interpretation of
