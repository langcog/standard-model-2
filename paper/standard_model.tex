...
\caption{\label{fig-glmer-ladder}}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1520}}
  >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.0720}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.0880}}
  >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.2160}}
...
\bottomrule\noalign{}
\endlastfoot
Wordbank longitudinal & English (American) &
(\textbf{CITE?})
& NA & NA & NA & --- \\
Wordbank longitudinal & Norwegian &
(\textbf{CITE?})
& NA & NA & NA & --- \\
Wordbank longitudinal & French (Quebecois) &
(\textbf{CITE?})
& NA & NA & NA & --- \\
Wordbank longitudinal & Japanese &
(\textbf{CITE?})
& NA & NA & NA & --- \\
Input-observed (IO) & BabyView &
(\textbf{CITE?})
& 22 & 5 (1--8) & 6--32 mo & Head-cam, n=5739 videos \\
Input-observed (IO) & SEEDLingS &
(\textbf{CITE?})
& 44 & 12 (6--13) & 6--17 mo & LENA, n=525 day recordings \\
Input-observed (IO) & AM2018 &
(\textbf{CITE?})
& 66 & 3 (1--3) & 16--24 mo & LENA, n=126 recordings \\
Input-observed (IO) & FMW2013 &
(\textbf{CITE?})
& 51 & 3 (1--3) & 18--30 mo & LENA, n=51 recordings \\
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{../figs/longitudinal/predictors_alpha_zeta_panel.png}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{../figs/longitudinal/exposure_to_learn_EN.png}
