...
their learning (\textbf{fernald2012?}).
...
individual words (\textbf{goodman2008?}; Hidaka 2013; \textbf{roy2015?};
\textbf{braginsky2020?}; \textbf{kachergis2022?}). These analyses reveal
that there is predictable word-level difficulty information but that
only a modest portion of the variation between words is carried by
frequency information. Words can be hard for a child to acquire because
they vary also in the complexity and concreteness of their meanings,
their syntactic category and syntactic context, their phonology, and
many other factors. In the current work, we estimate word difficulty as
a free parameter, and focus instead on variation between children.
...
Taking advantage of the equivalence of Rasch models to linear mixed
effects models (De Boeck et al. 2011), we fit the set of models shown in
Figure Figure~\ref{fig-schematic}. The model incorporating variation in
acceleration and efficiency was the best fitting model across all four
datasets, with AIC and BIC differences shown in \textbf{?@tbl-aic}.
Figure~\ref{fig-glmer-ladder} reveals
