...
The different models described above are not identifiable in
cross-sectional data. {[}WHY{]}.

\section{Results}\label{results}

To fit these longitudinal growth models, we retrieved longitudinal data
on children's vocabulary from Wordbank (\textbf{frank2017?}), an open
archive of data from the MacArthur-Bates Communicative Development
Inventory and its international adaptations. Table
Table~\ref{tbl-datasets} shows the four longitudinal datasets in
Wordbank with \(>100\) observations.
