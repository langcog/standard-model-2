...
and its \emph{quality} -- is related to variation in vocabulary
(\textbf{hart1999?}; Fernald and Marchman 2012; Weisleder and Fernald
2013; Anderson et al. 2021; Rowe 2012; Hirsh-Pasek et al. 2015; Coffey
and Snedeker 2026). While input quantity is relatively easy to measure,
...
across early childhood (Bergelson 2020; Fernald et al. 1998;
\textbf{fernald2006?}; Peter et al. 2019; Frank et al. 2026). Much of
this work relies on the ``looking while listening'' (LWL) paradigm, in
which children see two pictures (e.g.~a book and a car) and their eye
...
(\textbf{fernald2008?}; Frank et al. 2026) and relates to their
vocabulary and other language outcomes (\textbf{fernald2006?}; Marchman
and Fernald 2008; Fernald and Marchman 2012; Fernald, Marchman, and
Weisleder 2013; Peter et al. 2019; Frank et al. 2026). One hypothesis
proposed in this work is that greater language input leads to more rapid
processing, in a virtuous cycle in which faster processing in turn leads
to greater word learning (Weisleder and Fernald 2013). In the
...
\(\sigma_r=.53\), a value drawn from (\textbf{sperry2018?}), who
estimated a mean of 419k tokens per month (\$\pm\$1 SD: 329k -- 957k).
...
learning {[}(\textbf{smith2002?});Markman and Wachtel (1988);etc{]}, or
other sources.
