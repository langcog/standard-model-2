...
shown in \textbf{?@tbl-aic}. Figure~\ref{fig-glmer-ladder} shows the fit
of the four model variants; the increasing spread of children's
...
which we have data (\(\delta\)AIC
\texttt{RENDER\ AIC\ RANGE\ FOR\ LOG\ AGE\ VS\ LINEAR\ VARIANTS}; see
Supplemental Figure 2 for model fits).
