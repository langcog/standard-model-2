...
##
## Mirrors `model/scripts/chang_bergen_comparison.R`. Reads:
##   data/chang_bergen_2022/{bert,gpt2,bilstm,lstm}_sigmoids.txt   (BookCorpus-trained)
##   data/feng_2026/<model>_sigmoids.txt                            (CHILDES-trained, our pipeline)
...
##
## Produces:
##   outputs/figs/longitudinal/feng_slope_comparison.png            (kids + Feng only)
##   outputs/figs/longitudinal/feng_chang_bergen_slope_comparison.png  (kids + Feng + C&B)
##   outputs/figs/longitudinal/feng_slope_summary.csv
...
if (length(feng_files) == 0) {
  stop("No Feng sigmoid files under ", FENG_DIR,
       ". Run model/scripts/feng_eval/fit_per_word_sigmoid.py first.")
}
