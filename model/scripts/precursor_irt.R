...
##
## Outputs:
##   outputs/figs/longitudinal/retired/precursor_trajectories.png  spaghetti plot of
##                                                       per-child theta_a
##                                                       trajectories.
##   outputs/figs/longitudinal/retired/precursor_variation.png     sigma_theta vs.
##                                                       age + months-of-dev
##                                                       interpretation.
