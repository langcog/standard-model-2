...
## RUN LOCALLY.  Output: data/peekbank/cdi_master_item_key.csv
...
stanford <- read_csv("data/peekbank/stanford_cdi_items_long.csv", show_col_types = FALSE)
totlot   <- read_csv("data/peekbank/totlot_cdi_items_long.csv",   show_col_types = FALSE)
...
write.csv(master, "data/peekbank/cdi_master_item_key.csv", row.names = FALSE)
cat(sprintf("wrote data/peekbank/cdi_master_item_key.csv: %d items (%d in model-200; %d in all 6 datasets)\n",
